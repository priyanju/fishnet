   ...
   $scope.JobID;*/
    ...
    $scope.generate_report = function (gd, opid) {
      ...
      if ($scope.split == "Idlereason") {
        ...
        $http({
          method: 'GET',
          url: $rootScope.api_url + 'hmis?start_date=' + $scope.from_date + '&end_date=' + $scope.to_date + '&machine_id=' + $scope.MachineID + '&shift_id=' + $scope.ShiftID + '&operator_id=' + $scope.operator_id + '&report_type=' + $rootScope.wise
        })
          .then(function (response) {
            // $scope.reasonitem=[];
            $scope.myLoader = false;
      ...
      $http({
        method: 'GET',
        url: $rootScope.api_url + 'final_report?from_date=' + $scope.from_date + '&end_date=' + $scope.to_date + '&machine_id=' + $scope.MachineID + '&shift_id=' + $scope.ShiftID
      })
        .then(function (response) {
          $scope.myLoader = false;
          $scope.items = response.data;
    ...
    $scope.generate_chartreport = function (gd, opid) {
      ...
      if ($scope.split == "Idlereason") {
        ...
        $http({
          method: 'GET',
          url: $rootScope.api_url + 'hmi_report?start_date=' + $scope.from_date + '&end_date=' + $scope.to_date + '&machine_id=' + $scope.MachineID + '&shift_id=' + $scope.ShiftID + '&operator_id=' + $scope.operator_id + '&report_type=' + $rootScope.wise
        }).then(function (response) {
          $scope.myLoader = false;
        ...
        $http({
          method: 'GET',
          url: $rootScope.api_url + 'overall_hmi_report_chart?start_date=' + $scope.from_date + '&end_date=' + $scope.to_date + '&machine_id=' + $scope.MachineID + '&shift_id=' + $scope.ShiftID + '&operator_id=' + $scope.operator_id + '&report_type=' + $rootScope.wise
        }).then(function (response) {
          $scope.myLoader = false;
